...
$JITENDRA_PRO_DEV_X_DARK_SIDE = "app/data";
$JITENDRA_PRO_DEV_X_WHITE_SIDE = "app/playlist";
...
function doctor_strange($JITENDRA_PRO_DEV_X_URL,$JITENDRA_PRO_DEV_X_ROLEX)
{
  ...
  return  $JITENDRA_PRO_DEV_X_JSON_ENCODE;
    ...
    function video(){
      $LOKI = "https://i.ibb.co/qBqPyv8/iptv-logo.png";      
      return $LOKI;
    }
//=============================================================================//
...
function jitendra_pro_dev()
{
  ...
  $ROLEX['bgpic'] = 'https://i.ibb.co/68CLtgg/web-bg.jpg';
  $ROLEX['pimg'] = 'https://i.ibb.co/3k5wszQ/Player-bg.jpg';
  $ROLEX['himg'] = 'https://i.ibb.co/qBqPyv8/iptv-logo.png';
  $ROLEX['hname'] = "mac2m3u";
  $ROLEX['span'] = array("m", "a", "c", "2", "m", "3", "u");
  return $ROLEX;
}
